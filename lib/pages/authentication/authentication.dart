...
import 'package:admin_panel/controllers/register_controller.dart';
  ...
  String? validatePhoneNumber(String value) {
    ...
    if (registerController.emailController.text.isNotEmpty) {
      if (value.isEmpty) {
        ...
        return 'Enter a valid Pakistani phone number starting with +923';
      }
    }
    return null;
  }
            ...
            child: Column(
              ...
              children: [
                    ...
                    if (!isLoginScreen) {
                      ...
                      try {
                        ...
                        var snackbar = SnackBar(
                            ...
                            backgroundColor:
                                //custom auth
                                !result ? Colors.redAccent : Colors.green,
                            content: Center(
                              child: Text(
                                result
                                    ? "Admin Login Successful"
                                    : "Invalid Crendials For Admin",
                                style: const TextStyle(
                                  color: Colors.white,
                                  fontWeight: FontWeight.bold,
                                ),
                ...
                RichText(
                  ...
                  TextSpan(
                    text: isLoginScreen ? "" : "Already have an account?   ",
                  ),
                  TextSpan(
                      text: isLoginScreen ? "" : "Log In!",
