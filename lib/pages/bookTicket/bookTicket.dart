...
//       final bookTicketCollection =
//           FirebaseFirestore.instance.collection('bookTicket');
//       final QuerySnapshot querySnapshot = await bookTicketCollection.get();

//       if (querySnapshot.docs.isNotEmpty) {
//         final fetchedBookTicketList = querySnapshot.docs
//             .map(
//                 (doc) => BookTicket.fromMap(doc.data() as Map<String, dynamic>))
//             .toList();
...
//   final BookTicketController bookTicketController =
